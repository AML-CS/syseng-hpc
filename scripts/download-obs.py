...
values = {'email' : 'omejiaa@uninorte.edu.co', 'passwd' : pswd, 'action' : 'login'}
# Authenticate
...
if ret.status_code != 200:
    ...
    print(ret.text)
    exit(1)
dspath = 'https://rda.ucar.edu/data/ds351.0/'
...
for date in daterange(start_date, end_date):
    for i in range(0, 19, 6):
        filelist.append('little_r/{0:%Y}/OBS:{0:%Y}{0:%m}{0:%d}{1}'.format(date, pad_zero(str(i))))

#'little_r/2021/OBS:2021040300'
